...
final class SexualityAdmin extends AbstractExtraActionsAdmin
{
    use EnsurePredefinedTrait;
    protected $baseRouteName = 'shared_sexuality';
    protected $baseRoutePattern = 'shared/sexuality';
    protected $translationDomain = 'sexuality';
